...
var mongo = {
  ...
  connectionString: 'mongodb://127.0.0.1:27017/payment_gateway',
};
...
module.exports = {
  mongodb: {
    ...
    ssl: process.env.ME_CONFIG_MONGODB_SSL || false,
    ...
    auth: [
       ...
       */
      {
        ...
        password: process.env.ME_CONFIG_MONGODB_AUTH_PASSWORD || mongo.pass,
      },
    ],
