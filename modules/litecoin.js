...
exports.createAccount = async function (account) {
  ...
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/createaccount";
...
exports.createAddress = async function (account) {
  console.log('account: ', account);
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/createaddress";
...
exports.getBalance = async function (account, symbol) {
  console.log('account: ', account);
  let apiBalanceUrl = configs.node_api_url.LTC + "/api/v1/litecoin/getaccountbalance/" + account;
  ...
  let apiAddressUrl = configs.node_api_url.LTC + "/api/v1/litecoin/getaccountaddress/" + account;
...
exports.getBalanceByAccount = async function (account, symbol) {
  console.log('account: ', account);
  if (account == '') {
    return {status: 'fail', address: '', balance: 0};
  }

  let apiBalanceUrl = configs.node_api_url.BTC + "/api/v1/litecoin/getaccountbalance/" + account;
...
exports.listAaccounts = async function () {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/listaccounts";
...
exports.getTransaction = async function (txhash) {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/gettransaction/" + txhash;
...
exports.listTransactions = async function (coin, account, count = 1000000000, from = 0) {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/listtransactions";
...
exports.getReceivedByAddress = async function (address, confirm=2) {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/getreceivedbyaddress";
...
exports.sendFromAccount = async function (fromaccount, toaddress, amount, confirm = 2, symbol='LTC') {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/sendfrom";
...
exports.sendManyFromAccount = async function (fromaccount, toaddresses, confirm = 2, symbol='LTC') {
  let apiUrl = configs.node_api_url.LTC + "/api/v1/litecoin/sendmany";
